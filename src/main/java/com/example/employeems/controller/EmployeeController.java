...
@RestController //Response XAML,JSON walta auto convert
@RequestMapping("api/v1/employee")
public class EmployeeController {

    @Autowired // defedency injection
    ...
    public ResponseEntity searchEmployee(@PathVariable int empID){
        ...
        try{
            ...
            if(employeeDTO != null){
                ...
                responseDTO.setMessage("No Employee Availabe For this empID");
                responseDTO.setContent(null);
                return new ResponseEntity(responseDTO, HttpStatus.BAD_REQUEST);
            }
    ...
    public EmployeeDTO getEmpByEmpID(@PathVariable String empID){
